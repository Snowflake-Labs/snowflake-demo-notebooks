...
GRANT ROLE XGB_GPU_LAB_USER to USER <ENTER_USER_HERE>;
...
-- create csv format
CREATE FILE FORMAT IF NOT EXISTS XGB_GPU_DATABASE.XGB_GPU_SCHEMA.CSVFORMAT
    SKIP_HEADER = 0
    TYPE = 'CSV';
...
CREATE STAGE IF NOT EXISTS XGB_GPU_DATABASE.XGB_GPU_SCHEMA.VEHICLES 
    FILE_FORMAT = XGB_GPU_DATABASE.XGB_GPU_SCHEMA.CSVFORMAT 
...
FILES = ('vehicles.csv.gz') 
FILE_FORMAT = '"XGB_GPU_DATABASE"."XGB_GPU_SCHEMA"."temp_file_format_2024-07-23T22:06:51.932Z"' 
ON_ERROR=CONTINUE 
